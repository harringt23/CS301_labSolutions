        ...
        CompoundButton.OnCheckedChangeListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener
{
    ...
    // determine whether the user touched the screen
    @Override
    public boolean onTouch(View view, MotionEvent event) {
        // verify the user pushed down
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN)
        {
            Log.d("touchEvent", "onTouch");
            // get the coordinates of where the user touched
            ...
            // return true for successful event
            return true;
        }
        // otherwise, no touch happened
        return false;
    }
}
